...
export default function WhyTriMLVisual() {
  return (
    <div className="relative mx-auto w-full max-w-[420px] px-2 sm:max-w-md sm:px-0">
      <div
        aria-hidden
        className="why-orb absolute -left-6 top-4 h-36 w-36 rounded-full bg-brand-500/10 blur-3xl sm:h-48 sm:w-48"
      />
      <div
        aria-hidden
        className="why-orb why-orb--secondary absolute -right-4 bottom-16 h-28 w-28 rounded-full bg-blue-300/15 blur-3xl sm:h-36 sm:w-36"
      />

      <div className="why-visual-enter relative z-10 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl shadow-slate-200/60 sm:rounded-3xl sm:p-5">
      ...
      <div className="relative z-20 -mt-3 ml-auto mr-2 w-fit sm:-mt-4 sm:mr-6">
      ...
      <div className="relative z-10 mt-4 flex flex-wrap items-stretch justify-center gap-2 sm:gap-3">
        <div className="flex flex-1 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 shadow-sm sm:flex-none sm:min-w-[140px]">
